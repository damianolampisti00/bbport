...
- [BerryCore](https://github.com/sw7ft/BerryCore) installed on the device, with `ffmpeg`, `python3`, and [`parth-dl`](https://github.com/parthmax2/parth-dl) available — required for video transcoding and Instagram Reel/carousel playback. Everything else (login, messaging, E2EE, photo/video/voice download) works without BerryCore.
